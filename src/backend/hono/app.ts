...
import { registerCourseManageRoutes } from '@/features/courses/backend/manage.route';
import { registerAssignmentManageRoutes } from '@/features/assignments/backend/manage.route';
...
export const createHonoApp = () => {
  ...
  registerCourseManageRoutes(app);
  registerAssignmentManageRoutes(app);
